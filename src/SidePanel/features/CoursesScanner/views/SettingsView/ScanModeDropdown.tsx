...
type ScanModeValue = "single-course" | "term";

interface ScanModeDropdownProps {
  value: ScanModeValue;
  onChange: (value: ScanModeValue) => void;
}

function ScanModeDropdown({ value, onChange }: ScanModeDropdownProps) {
  return (
    <Select.Root value={value} onValueChange={(nextValue) => onChange(nextValue as ScanModeValue)}>
